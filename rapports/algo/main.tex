...
\begin{enumerate}
\item Un tableau de booléens représentant les murs verticaux ;
\item Un tableau de booléens représentant les murs horizontaux.
\end{enumerate}
...
Toutes les implémentations \textbf{d'algorithme} sont trouvables dans le package \texttt{algorithm} : \href{https://gitlab.univ-lille.fr/sae302/2025/G2_SAE3.3/-/tree/master/labyrinth/src/main/java/fr/univlille/labyrinth/model/algorithm?ref_type=heads}{Implémentation Java}
...
\href{https://gitlab.univ-lille.fr/sae302/2025/G2_SAE3.3/-/blob/master/labyrinth/src/main/java/fr/univlille/labyrinth/model/algorithm/pathsearch/MazeDistance.java?ref_type=heads}{Implémentation Java}

\newpage 

\subsection{Liaison distance/algorithme}

Tous les algorithmes de génération héritent de la classe abstraite \texttt{MazeAlgorithm}, qui applique toujours le même schéma :
...
Cela permet de réunir les comportements communs et d'avoir une modularité accrue des algorithmes.
...
\href{https://gitlab.univ-lille.fr/sae302/2025/G2_SAE3.3/-/blob/master/labyrinth/src/main/java/fr/univlille/labyrinth/model/algorithm/MazeAlgorithm.java?ref_type=heads}{Implémentation complète}
...
\obs{La différence entre la version avec et sans distance (à $n$) relève davantage de la variance des résultats que d'un écart fondamental de complexité algorithmique.}
